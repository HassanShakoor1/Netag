    ...
    <TransitionGroup component={null}>
      ...
      >
        ...
        <Route path="/" element={<Front />} />
          ...
          <Route
            path="/home/order"
            element={<ProtectedRoute element={<ManageOrder />} />}
          />
          <Route
            path="/home/order/singleorder/:orderId" // Add a slash before :orderId
            element={<ProtectedRoute element={<ManageScreen2 />} />}
          />
          <Route
            path="/home/order/order3"
            element={<ProtectedRoute element={<ManageOrder3 />} />}
          />
          <Route path="/home/services" element={<Categories />} />
          <Route
            path="/home/services/catagory/:id"
          ...
          <Route
            path="/edit-product-detail/:id/:productid?"
            element={<EditProductDetail />}
          />
          <Route
            path="/home/services/catagory/:id"
            element={<Managecatagories />}
          />
          <Route path="/home/setting" element={<Setting />} />
          ...
          />
          <Route path="/edit-contact" element={<EditContact />} /> Add this
          route
          <Route path="/edit-product" element={<ProductCatagory />} /> Add this
          route
          <Route path="/product-catagory" element={<Addcatagory />} /> Add this
          route
          <Route path="/product-catagory/:id" element={<Addcatagory />} /> Add
          this route
          <Route path="/edit-product-catagory" element={<EditProduct />} /> Add
          this route
          <Route
          ...
          <Route path="/Analytics-page" element={<Analytics />} /> Add this
          route
          <Route path="/setting-page" element={<Scanner />} /> Add this route
          <Route
            path="/home/services/serviceaddcategory"
            element={<Serviceaddcategory />}
          ></Route>
          <Route
            path="/home/services/serviceeditcategory/:id"
            element={<Serviceeditcategory />}
          ></Route>
          <Route
            path="/home/services/catagory-products/:id/serviceaddcategory-product"
            element={<ManagecategoriesAddnewProduct />}
          ></Route>
          <Route
            path="/home/services/catagory/ManageCategories-products-Edit/:id"
            element={<ManageCategoriesEdit />}
          ></Route>
          {/* create new profile  */}
          <Route
            path="/home/create-new-profile/:id?"
          ...
          />
          <Route
            path="/home/services/catagory/:id/serviceaddcategory"
            element={<ManageCategoriesAddNew />}
          />
