...
function Footer(Links) {
  ...
  const handleAnalytics = () => {
    navigate("/Analytics-page"); // Pass Links to the Analytics page
  };
  const handleSetting = () => {
        ...
        <div className="Footer">
          <div className="f-icons">
            ...
            <IoIosQrScanner
              ...
              style={
                location.pathname === "/active-card" ? activeStyle : iconStyle
              }
            />
            <IoAnalyticsOutline
              onClick={handleAnalytics}
              style={
                location.pathname === "/Analytics-page"
                  ? activeStyle
                  : iconStyle
              }
            />
            <IoMdSettings
              ...
              style={
                location.pathname === "/home/setting" ? activeStyle : iconStyle
              }
            />
            <div className="extra">
